...
public class GlobalAchievementManager : MonoBehaviour
{
    ...
    void LoadData()
    {
        ...
        _achievements.Add(new Achievement(0, "Red Barrels", "Isn't it weird that all red barrels in games always explode? Who puts them there?", "Found in [<color=#fede34>The Lab</color>]", false, "Achievement/Barrel"));
        _achievements.Add(new Achievement(1, "One Man Army", "You are always the hero, the big guy, the one man army that can take on legions of enemies.", "Found in [<color=#fede34>Zombie Invasion</color>]", false, "Achievement/OneManArmy"));
        _achievements.Add(new Achievement(2, "Escort Quests", "You have defeated gods and devils, and here you are escorting a way too slow NPC to a door...", "Found in [<color=#fede34>The Hallway</color>]", false, "Achievement/Escort"));
        _achievements.Add(new Achievement(3, "Bikini armor", "So male heroes get awesome armor, and female heroes get... bikinis?", "Found in [<color=#fede34>Magical Shop</color>]", false, "Achievement/Bikini"));
        ...
        _achievements.Add(new Achievement(6, "Woodchopping Hands", "Hit a tree, get wood, hit more, get more wood", "Found in [<color=#fede34>Deep Under</color>]", false, "Achievement/Wood"));
        ...
        _achievements.Add(new Achievement(8, "Eating Apples", "Oh no, i'm almost dead. Let me just eat 30 apples to heal up!", "Found in [<color=#fede34>Magical Shop</color>]", false, "Achievement/Apple"));
        _achievements.Add(new Achievement(9, "Health Does not matter", "So, I took massive amounts of damage, yet I can still run, shoot and jump like nothing happend?", "Found in [<color=#fede34>Zombie Invasion</color>]", false, "Achievement/Escort"));
        ...
        _achievements.Add(new Achievement(12, "Heroes can't swim", "You can beat demons, seduce angels, but water stays your deadliest enemy", "Found in [<color=#fede34>The Hallway</color>]", false, "Achievement/CantSwim"));
        ...
        _achievements.Add(new Achievement(18, "The water level", "Every game must have a water level, its just not a real game without one!", "Found in [<color=#fede34>Deep Under</color>]", false, "Achievement/Water"));
        _achievements.Add(new Achievement(19, "The fishing game", "Dont forget about the mandatory fishing skill in any crafting game!", "Found in [<color=#fede34>A Fishing Trip</color>]", false, "Achievement/Fishing"));
        ...
        _achievements.Add(new Achievement(21, "Breakable Vazes", "Lets just go around the world and break random pottery.", "Found in [<color=#fede34>Magical Shop</color>]", false, "Achievement/BreakableVazes"));
        ...
        _achievements.Add(new Achievement(24, "KONAMI Code", "We might be the 100th game to implement this code", "Found in [<color=#fede34>Magical Shop</color>]", false, "Achievement/Konami"));
        _achievements.Add(new Achievement(25, "Falling platforms", "Ofcourse this random platform would fall", "Found in [<color=#fede34>The Lab</color>]", false, "Achievement/FallingPlatforms"));
        ...
        _achievements.Add(new Achievement(28, "Lootboxes", "Random loot, that may or may not make you stronger. For hard cash!", "Found in [<color=#fede34>Magical Shop</color>]", false, "Achievement/Lootboxes"));
        _achievements.Add(new Achievement(29, "Hidden collectibles", "Who put this here...?", "Found in [<color=#fede34>The Lab</color>]", false, "Achievement/Collectables"));
        ...
        _achievements.Add(new Achievement(31, "You caught an old boot", "Why is every fishing spot littered with these ?", "Found in [<color=#fede34>Deep Under</color>]", false, "Achievement/OldBoot"));
        _achievements.Add(new Achievement(32, "You caught a treasure chest", "If only my local fishing spot was littered with these !", "Found in [<color=#fede34>Deep Under</color>]", false, "Achievement/TreasureChest"));
    ...
    {
        return _achievements.Count(x => x.Achieved);
    }

    public bool AreAllAchievementsCompleted()
    {
        return GetCompletedAchievementCount() == 25;
    }
