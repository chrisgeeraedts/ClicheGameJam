...
public class GlobalAchievementManager : MonoBehaviour
{
    ...
    void LoadData()
    {
        ...
        _achievements.Add(new Achievement(8, "Eating Apples", "Oh no, i'm almost dead. Let me just eat 30 apples to heal up!", "Found in [<color=#fede34>???</color>]", false, "Achievement/Apple"));
            ...
            _achievements.Add(new Achievement(10, "The Evil Monoloque", "The endless jammering of a boss, explaining his plan so you can stop it just in time.", "Found in [<color=#fede34>Final Boss - 1</color>]", false, "Achievement/PLACEHOLDER"));
            _achievements.Add(new Achievement(11, "Boss Transformations", "You killed the final boss, but oh wait, he transforms into something bigger and stronger", "Found in [<color=#fede34>Final Boss - 2</color>]", false, "Achievement/PLACEHOLDER"));
            _achievements.Add(new Achievement(12, "Heroes can't swim", "You can beat demons, seduce angels, but water stays your deadliest enemy", "Found in [<color=#fede34>Escort Minigame</color>]", false, "Achievement/PLACEHOLDER"));
